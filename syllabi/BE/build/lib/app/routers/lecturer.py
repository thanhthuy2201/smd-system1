...
from app.schemas.lecturer import (
    ...
    SyllabusFullCreate, SyllabusDraftSave, SyllabusValidationResult, ValidationError,
...
def get_my_syllabi(
    ...
    syllabi = query.order_by(Syllabus.created_date.desc()).offset(skip).limit(limit).all()
